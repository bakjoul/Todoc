...
public class TaskAdapter extends ListAdapter<TaskViewState, TaskAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(@NonNull TaskViewState taskViewState) {
            b.taskItemProjectColor.setColorFilter(taskViewState.getProjectColor());
            b.taskItemDescription.setText(taskViewState.getTaskDescription());
            b.taskItemProject.setText(taskViewState.getProject());
        }
    }

    private static class TaskAdapterDiffCallback extends DiffUtil.ItemCallback<TaskViewState> {
